    ...
    <div className={`${variants[variant]} ${className}`}>
      <div className="max-w-3xl mx-auto">
        <nav aria-label="Progress">
          {variant === 'simple' ? (
            // Simple variant with cleaner design
              ...
              {steps.map((step, stepIdx) => (
                <li key={step.id} className="relative flex items-center">
                  ...
                  <div className={`
                    ...
                    rounded-full transform transition-transform hover:scale-110
                  ...
                  {/* Label */}
                  <span className="ml-2 text-sm font-medium text-[#2F2F2F]">
                    {step.name}
                  </span>
                  
                  {/* Connector line */}
                  {stepIdx !== steps.length - 1 && (
                    <div className="mx-4 w-12 h-0.5 bg-[#E4E4E4]" aria-hidden="true" />
                  )}
                </li>
              ))}
            </ol>
